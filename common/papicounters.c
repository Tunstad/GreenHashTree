...
char papi_events[NUM_EVENTS][PAPI_MAX_STR_LEN]={
		"perf::PERF_COUNT_HW_INSTRUCTIONS:mg=0:mh=0",
		"perf::PERF_COUNT_HW_CPU_CYCLES:mg=0:mh=0",
		"perf::PERF_COUNT_HW_CACHE_L1D:MISS:mg=0:mh=0",
		"perf::PERF_COUNT_HW_CACHE_L1D:ACCESS:mg=0:mh=0",
		...
		"perf::PERF_COUNT_HW_CACHE_DTLB:MISS:mg=0:mh=0",
		"perf::PERF_COUNT_HW_CACHE_DTLB:ACCESS:mg=0:mh=0",
		"perf::BRANCH-MISSES:mg=0:mh=0",
		"perf::BRANCHES:mg=0:mh=0",
};
